...
export const translations: Record<Language, TranslationSet> = {
  ...
  en: {
    ...
    nav_risk_prediction: 'Crime Forecast',
    ...
    page_risk_prediction: 'AI-assisted Risk Assessment',
    ...
    sub_risk_prediction: 'AI-assisted crime risk assessment based on historical patterns',
    ...
    btn_generate_prediction: 'Run AI Risk Assessment',
    btn_refresh: 'Refresh',
    ...
    pred_high_risk_districts: 'Elevated Risk Districts',
    pred_crime_spikes: 'Estimated Crime Spikes',
    pred_recommendations: 'Decision Support Recommendations',
    pred_threat_level: 'Estimated Threat Level',
    pred_confidence: 'Confidence',
    pred_overall_analysis: 'AI Risk Analysis Summary',
    pred_last_updated: 'Last updated',
    pred_generating: 'Estimating crime risk index...',
    pred_no_prediction: 'Click "Run AI Risk Assessment" to generate AI-assisted risk assessment for the next 30 days.',
  ...
  kn: {
    ...
    pred_crime_spikes: 'ಮಾದರಿ ಆಧಾರಿತ ಅಪಾಯ ಏರಿಕೆ',
    pred_recommendations: 'ನಿರ್ಧಾರ ಬೆಂಬಲ ಶಿಫಾರಸುಗಳು',
    pred_threat_level: 'ಒಟ್ಟು ಬೆದರಿಕೆ ಮಟ್ಟ',
    pred_confidence: 'ವಿಶ್ವಾಸ ಮಟ್ಟ',
    pred_overall_analysis: 'AI ಅಪಾಯ ವಿಶ್ಲೇಷಣೆ ಸಾರಾಂಶ',
    pred_last_updated: 'ಕೊನೆಯ ನವೀಕರಣ',
    pred_generating: 'ಅಪರಾಧ ಅಪಾಯ ಅಂದಾಜು ಮಾಡಲಾಗುತ್ತಿದೆ...',
    pred_no_prediction: '"AI ಅಪಾಯ ಅಂದಾಜು ಚಾಲನೆ ಮಾಡಿ" ಕ್ಲಿಕ್ ಮಾಡಿ ನೈಜ-ಸಮಯ AI ವಿಶ್ಲೇಷಣೆ ಪಡೆಯಿರಿ.',
